  ...
  return (
    <div className="mt-20 bg-[#FFF8FA] w-full h-fit">
      <div className={`${styles.section} p-6`}>
        <h4 className="text-center pb-12 pt-8 font-bold text-6xl text-[#DC143C]">
          What is Reiki?
        </h4>
        <div className="flex justify-center space-x-5">
          <div className=" w-1/2 font-urbanist text-base font-medium leading-9">
            <p>
        ...
        <h3 className="text-center pt-14 pb-8 font-urbanist text-lg">
